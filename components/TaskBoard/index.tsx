...
import AddTeamTaskModal from "../Modals/TeamModal/AddTeamTaskModal";
import UserProfile from "../UserProfile";
import styles from "./taskboard.module.css";

export default function BugDetailBoard(props:any) {

    const { projectData, projectTeamList, creator, taskData, closeBoard } = props;
    ...
    const [addTeamTaskModal, setAddTeamTaskModal] = useState(false);
    ...
    return (
        <div className={styles.container}>
            <div className={styles.overlay} onClick={()=> closeBoard()}></div>
            <div className={styles.detail_board}>
            {
                (addTeamTaskModal)
                ?   <div className={styles.add_team_task_modal_wrapper}>
                        <AddTeamTaskModal 
                            projectTeam={projectTeamList}
                            projectCreator={projectData.createdBy}
                            closeModal={()=> setAddTeamTaskModal(false)} 
                        />
                    </div>
                :   <div>
                        <div className={styles.head}>
                            ...
                            </div>
                            {
                                ...
                                :   <div className={styles.warning}> 
                                        <MdWarning /> No Team Assigned
                                    </div>
                            }
                            <div className={styles.add_member_task_wrapper}>
                                <IconButton icon={AiOutlineUsergroupAdd} onclick={ ()=> setAddTeamTaskModal(true) } />
                            </div>
                        </div>
